package kikim.test01.common.web;
...
import kikim.test01.common.logger.LoggerInterceptor;
...
public class CommonErrorController {
	...
	@RequestMapping(value="/cmm/error/error{error_code}.do")
    public ModelAndView error(HttpServletRequest request, @PathVariable String error_code) {
        ModelAndView mv = new ModelAndView("/cmm/error/cmmError");
